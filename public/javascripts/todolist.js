...
async function showlist(data)
{
    ...
    for (const item of data) {
        ...
        const textnode_id = document.createTextNode("ID:" + value.id);  
        ...
        const textnode_ratings= document.createTextNode("Ratings:" + item.ratings.toString());   
        const textnode_reviews= document.createTextNode("Reviews:" + JSON.stringify(item.reviews, null, 1));  

        //node.appendChild(textnode_id); 
